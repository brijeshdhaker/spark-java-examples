package com.spark.java.tutorial.sparkSql.join;

import com.spark.java.tutorial.sparkSql.EmployeeCustomJoin;
...
public class CustomJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Dataset<Row> employeeDF = mySparkSession.createDataset(listEmp, Encoders.bean(EmployeeCustomJoin.class)).toDF();
        ...
        Dataset<Row> deptDF = mySparkSession.createDataset(listdept, Encoders.bean(Department.class)).toDF();
