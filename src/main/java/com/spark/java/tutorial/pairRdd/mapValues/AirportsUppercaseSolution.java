package com.spark.java.tutorial.pairRdd.mapValues;

import com.spark.java.tutorial.rdd.commons.Utils;
...
public class AirportsUppercaseSolution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD<String, String> upperCase =
                airportPairRDD.mapValues(countryName -> countryName.toUpperCase());
    ...
    private static PairFunction<String, String, String> getAirportNameAndCountryNamePair() {
        return (PairFunction<String, String, String>) line -> new Tuple2<>
