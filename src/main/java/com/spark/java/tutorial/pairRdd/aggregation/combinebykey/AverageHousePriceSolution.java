package com.spark.java.tutorial.pairRdd.aggregation.combinebykey;

import com.spark.java.tutorial.pairRdd.aggregation.reducebykey.housePrice.AvgCount;
...
public class AverageHousePriceSolution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD<String, AvgCount> housePriceTotal=
                housePricePairRdd.combineByKey(createCombiner, mergeValue, mergeCombiners);

        JavaPairRDD<String, Double> housePriceAvg =
                housePriceTotal.mapValues(avgCount -> avgCount.getTotal()/avgCount.getCount());
    ...
    static Function2<AvgCount, Double, AvgCount> mergeValue = (avgCount, x) ->
            new AvgCount(avgCount.getCount() + 1,
                    avgCount.getTotal() + x);
